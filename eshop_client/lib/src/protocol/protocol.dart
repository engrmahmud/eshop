...
import 'subcategory.dart' as _i4;
import 'user.dart' as _i5;
import 'package:eshop_client/src/protocol/category.dart' as _i6;
import 'package:eshop_client/src/protocol/product.dart' as _i7;
import 'package:eshop_client/src/protocol/subcategory.dart' as _i8;
import 'package:eshop_client/src/protocol/user.dart' as _i9;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i8.Subcategory>) {
      return (data as List).map((e) => deserialize<_i8.Subcategory>(e)).toList()
          as T;
    }
    if (t == List<_i9.User>) {
      return (data as List).map((e) => deserialize<_i9.User>(e)).toList() as T;
    }
    try {
