...
import 'subcategory.dart' as _i7;
import 'user.dart' as _i8;
import 'package:eshop_server/src/generated/category.dart' as _i9;
import 'package:eshop_server/src/generated/product.dart' as _i10;
import 'package:eshop_server/src/generated/subcategory.dart' as _i11;
import 'package:eshop_server/src/generated/user.dart' as _i12;
...
class Protocol extends _i1.SerializationManagerServer {
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'subcategory_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'name',
          columnType: _i2.ColumnType.text,
      ...
      foreignKeys: [
        _i2.ForeignKeyDefinition(
          constraintName: 'subcategory_fk_0',
          columns: ['categoryId'],
          referenceTable: 'category',
          referenceTableSchema: 'public',
          referenceColumns: ['id'],
  ...
  T deserialize<T>(
    ...
    if (t == List<_i11.Subcategory>) {
      return (data as List)
              .map((e) => deserialize<_i11.Subcategory>(e))
              .toList()
          as T;
    }
    if (t == List<_i12.User>) {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is Map<String, dynamic> && data['__className__'] is String) {
      return (data['__className__'] as String).replaceFirst('eshop.', '');
    }
